                                                ...
                                                vkWinInfo(new QvkWinInfo)
{
    ...
    if ( vkSettings.getVideoPath().isEmpty() == true ) {
    ...
    if ( vkSettings.getPicturePath().isEmpty() == true ) {
        qDebug().noquote() << global::nameOutput << "User Picturepath:" << QStandardPaths::writableLocation( QStandardPaths::PicturesLocation );;
    } else {
        qDebug().noquote() << global::nameOutput << "User Picturepath:" << vkSettings.getPicturePath();
    }
    qDebug();
