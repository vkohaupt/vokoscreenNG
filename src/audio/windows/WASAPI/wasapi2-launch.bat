C:\gstreamer\1.0\msvc_x86_64\bin\gst-launch-1.0.exe -e ^
    d3d11screencapturesrc monitor-handle=65537 show-cursor=true ^
        ...
        ! queue ^
        ! mux. ^
    wasapisrc low-latency=true role=multimedia device="\\\\\?\\SWD\#MMDEVAPI\#\{0.0.1.00000000\}.\{2dd319ce-b622-4b87-b789-cc74e2b0d457\}\#\{2eef81be-33fa-4800-9670-1cd474972c3f\}" ^
        ! audioconvert ^
        ! audiorate ^
