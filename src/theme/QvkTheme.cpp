...
void QvkTheme::slot_setNewTheme()
{
    ...
    makeAndSetValidIcon( ui->tabWidgetScreencast, ui->tabWidgetScreencast->indexOf( ui->tabVideo ),     VK_getIcon( "applications-multimedia", ":/pictures/screencast/microphone.png" ) );
