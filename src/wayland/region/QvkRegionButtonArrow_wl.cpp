...
QvkRegionButtonArrow_wl::QvkRegionButtonArrow_wl()
{
}
...
QPixmap QvkRegionButtonArrow_wl::getButton( QColor color )
{
...
QPixmap QvkRegionButtonArrow_wl::getArrow( degreeArrow degree, QColor colorSelected )
{
    QPixmap pixmap( diameter+penWidth, diameter+penWidth );
    pixmap.fill( Qt::transparent );
...
QPixmap QvkRegionButtonArrow_wl::getPixmapHandle( QColor color, QColor colorSelected ,degreeArrow degree )
{
    QPixmap pixmap( diameter+penWidth, diameter+penWidth );
    pixmap.fill( Qt::transparent );
...
int QvkRegionButtonArrow_wl::getWithHalf()
{
