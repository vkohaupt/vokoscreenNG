...
QvkCountdownWindow_wl::QvkCountdownWindow_wl( QWidget *parent )
{
    setParent( parent );
...
QvkCountdownWindow_wl::~QvkCountdownWindow_wl()
{
}


void QvkCountdownWindow_wl::paintEvent( QPaintEvent *event )
{
  (void)event;
...
void QvkCountdownWindow_wl::mousePressEvent( QMouseEvent *event )
{
