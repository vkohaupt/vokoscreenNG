...
QvkHelp_wl::QvkHelp_wl( Ui_formMainWindow_wl *ui_mainwindow ) : uiHelp(new(Ui::help_wl))
{
    ui = ui_mainwindow;
    uiHelp->setupUi( this );
...
QvkHelp_wl::~QvkHelp_wl()
{
}


void QvkHelp_wl::slot_parse_locale( QStringList list )
{
...
bool QvkHelp_wl::eventFilter(QObject *object, QEvent *event)
{
 ...
 */
void QvkHelp_wl::loadHTML( QString value )
{
...
bool QvkHelp_wl::isFileInLine( QString line )
{
    bool value = false;
...
int QvkHelp_wl::getCountFileToDownload( QString tempPathFileName )
{
 ...
 */
void QvkHelp_wl::slot_parseHTML( QString tempPathFileName )
{
    localFiles.clear();
 ...
 */
void QvkHelp_wl::slot_showHelp( QString tempPathFileName )
{
    QDir dir;
