...
typedef struct _CustomDataWEBM
{
...
class QvkConvert_mkv_to_webm_wl: public QWidget
{
    Q_OBJECT
public:
    QvkConvert_mkv_to_webm_wl( Ui_formMainWindow_wl *vk_ui );
...
private:
    ...
    static void on_finished_cb( GstDiscoverer *discoverer, CustomDataWEBM *data );
    static void on_discovered_cb( GstDiscoverer *discoverer, GstDiscovererInfo *info, GError *err, CustomDataWEBM *data );
