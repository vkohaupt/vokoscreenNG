...
- Required from version >= 4.10.0
  ...
  **obsolete** The Qt installer needs the 32 bit version of vc_redist.x86.exe  
  **obsolete** https://aka.ms/vs/16/release/vc_redist.x86.exe  
  
  Qt Online Installer https://www.qt.io/development/download-qt-installer-oss
    - Qt 6.10.0  
      [+] **obsolete** MinGW 11.2.0 64-bit  
