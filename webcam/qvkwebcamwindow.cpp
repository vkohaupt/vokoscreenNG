...
void QvkWebcamWindow::leaveEvent(QEvent *event)
{
    Q_UNUSED(event);
    widgetMenueBackground->setVisible( false );
    myWidgetHelp->setVisible( false );
...
void QvkWebcamWindow::enterEvent(QEvent *event)
{
    Q_UNUSED(event);
...
void QvkWebcamWindow::slot_frameOnOff( bool value )
{
  if ( value == true )
  {
...
void QvkWebcamWindow::slot_set160x120()
{
    resize( 160, 120 );
}


void QvkWebcamWindow::slot_set320x240()
{
    resize( 320, 240 );
}


void QvkWebcamWindow::slot_set640x480()
{
    resize( 640, 480 );
}


void QvkWebcamWindow::slot_closeWebcamWindow()
{
    close();
}
